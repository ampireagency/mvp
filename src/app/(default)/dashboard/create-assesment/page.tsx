...
const page = () => {
  return (
    <>
      <h1 className="px-4 lg:ps-64 w-full flex text-2xl font-bold items-center justify-center py-6 text-black">
        Create assessment
      </h1>
      <div className="lg:ps-64 w-full flex  h-[60vh] items-center justify-center">
